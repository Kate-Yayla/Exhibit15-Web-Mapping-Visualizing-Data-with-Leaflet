...
function createFeatures(earthquakeData) {
  ...
  var earthquakes = L.geoJson(earthquakeData, {
    pointToLayer: function (data, latlng) {
      // console.log(latlng)
      // console.log(data.properties.magType*6)
      // console.log(getColor(data.properties.magType))
      // console.log(data.properties.place)
      // console.log(new Date(data.properties.time))
...
function createMap(earthquakes) {
  ...
  var grayscale = L.tileLayer("https://api.mapbox.com/styles/v1/mapbox/dark-v9/tiles/256/{z}/{x}/{y}?access_token={accesstoken}", {
    maxZoom: 18,
    accesstoken: API_KEY
  }
  );
